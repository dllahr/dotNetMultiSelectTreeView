...
//      04/2016
//          - option to disable color swap
//          - selection check made public
//			- select all method added
//			- SelectionNodeCollection remade to use hashset
// *****************************************************************************
...
namespace CodersLab.Windows.Controls
{
    ...
    public class TreeView : System.Windows.Forms.TreeView
    {
        ...
        public bool SwapColoursOnSelection
        {
            get;
            set;
        }
        ...
        private bool IsClickOnNode(TreeNode tn, MouseEventArgs e)
        {
            ...
            int rightMostX = tn.Bounds.X + tn.TreeView.Width;
    ...
    /// </summary>
    public class NodesCollection : IEnumerable<TreeNode>
    {
        protected HashSet<TreeNode> Set = new HashSet<TreeNode>();
